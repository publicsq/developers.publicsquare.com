...
const sidebars: SidebarsConfig = {
  docs: [
    ...
    },
    {
      ...
      items: ["concepts/accounts", "concepts/api-keys", "concepts/transactions", "concepts/disputes", "concepts/fraud-details-and-prevention", "concepts/webhooks", "concepts/onboarding"],
    },
    {
      type: "html",
      value: "<hr />",
