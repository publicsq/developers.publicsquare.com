...
* **Seller** - This type of onboarding is available when an account is [invited by a marketplace as a seller](/guides/marketplaces/onboard-sellers). Accounts onboarded only as a seller cannot process payments directly with Credova.
