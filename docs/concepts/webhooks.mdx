...
| `payment-intents:update`     | This event publishes the [Payment Intent](/api/financial/get-payment-intent-by-id) entity when a payment intent is created or updated.                                                     |
