...
| `transfer`   | Transfers are used to send funds to seller accounts when creating a payment. For instance, if you charge a customer $300, you can transfer $100 to three different sellers as part of the same payment.               |
