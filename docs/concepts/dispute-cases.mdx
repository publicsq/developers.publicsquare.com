...
3. **Dispute Case**: Credova creates a dispute case to track the process
...
When a dispute occurs, Credova automatically creates adjustments to track the financial impact:
...
Credova sends webhook notifications when dispute cases are created or updated:
...
The Credova Portal provides a comprehensive dispute management interface where you can:
