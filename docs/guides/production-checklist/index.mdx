...
<QuestionCard showDefault={true} question="Is your descriptor properly configured with the processor?">
  <Content type="default">
    <Alert type="question">What is a <Tooltip text="Missing info here">descriptor</Tooltip>?</Alert>
  </Content>
  <Content type="no">
    <Alert type="warning" subQuestion={<>What is a <Tooltip text='Missing info here'>descriptor</Tooltip>?</>}>Configure your onboarding [here].</Alert>
  </Content>
  <Content type="na">
    <Alert type="neutral" subQuestion={<>What is a <Tooltip text='Missing info here'>descriptor</Tooltip>?</>}>This is not necessary, but many merchants prefer to control how their charges look on a customer’s bank statements.</Alert>
  </Content>
</QuestionCard>
...
<QuestionCard showDefault={true} question="Have you integrated PSQ payments into your test environment for your website?">
  <Content type="default">
    <Alert type="question">What is a test <Tooltip text="Missing info here">environment</Tooltip>?</Alert>
  </Content>
  <Content type="no">
    <Alert type="warning" subQuestion={<>What is a test <Tooltip text='Missing info here'>environment</Tooltip>?</>}>Please complete [this process](https://developers.publicsquare.com/sdks/) in order to test various payment flows.</Alert>
  </Content>
  <Content type="na">
    <Alert type="question">What is a test <Tooltip text="Missing info here">environment</Tooltip>?</Alert>
  </Content>
