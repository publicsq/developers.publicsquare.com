...
<div style={{textAlign: 'center'}}>
  ...
  <img style={{ boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }} alt="Test Mode" src="/img/guides/merchants/test-mode.png" width="300"/>
...
<div style={{textAlign: 'center'}}>
  ...
  <img style={{ boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }} alt="Secret Key" src="/img/guides/merchants/publishable-key.png" width="700"/>
...
<div style={{textAlign: 'center'}}>
  ...
  <img style={{ boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }} alt="Secret Key" src="/img/guides/merchants/secret-key.png" width="700"/>
