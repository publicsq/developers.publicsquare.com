...
<Alert>This behavior requires Credova Elements SDKs v1.15.1 or later. See the [Migration Notes](#migration-notes) below if you're upgrading from an older version.</Alert>
...
- As of v1.15.1, the Google Pay sheet also requests a billing **phone number** alongside the full billing address. It needs no configuration and is included in the stored `billing_details`.
