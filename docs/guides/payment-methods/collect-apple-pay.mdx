...
<head>
    ...
    <script>
      ...
      function onApplePayButtonClicked() {
        ...
        // See below for createApplePaySession function
...
After the customer has authorized the payment, your application will need to call our `create` method from the SDK with the encrypted Apple Pay token to store the apple pay in your account.
