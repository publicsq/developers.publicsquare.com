...
Now that you have completed the [Collect Apple Pay](/guides/payment-methods/collect-apple-pay) guide, let's process a Apple Pay payment with the newly captured Apple Pay.
