...
Every payment, payout, transfer, refund, and settlement in the Credova system is associated with a transaction. Credova leverages double entry accounting to track debit credits.
...
Credova offers the ability to [search](/api/financial/get-all-transactions) and [export](/api/financial/export-transactions) across most fields of a customer, payment method, and transaction.
