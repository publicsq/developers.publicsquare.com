...
bank account based upon the sum of that days transactions. This process generates a Settlement record in the Credova system which summarizes that days transactions and creates an association
