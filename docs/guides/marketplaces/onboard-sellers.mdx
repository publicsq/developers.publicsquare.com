...
PublicSquare provides an [onboarding review endpoint](/api/accounts/review-onboarding) to be able to check the status of your onboarding requirements and submission status:
