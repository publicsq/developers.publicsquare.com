...
- Recommended: Credit/Debit Card.
- This title will be displayed to customers at checkout.

**Description:**

- Recommended: Pay with your credit card via PublicSquare.
- This description will appear below the payment title during checkout.

**PublicSquare Public API Key:**

- Obtain your **Public API Key** from the **PublicSquare Portal**.
- Copy and paste it into this field.

**PublicSquare Secret API Key:**

- Obtain your **Secret API Key** from the **PublicSquare Portal**.
- Copy and paste it into this field.

**Payment Capture Action:**

- Set to: **Authorize & Capture**.
- This setting ensures that payments are authorized and captured in a single action.
...
•	You can test payments using the PublicSquare sandbox environment.
...
7.	**How do I troubleshoot if payments don’t appear in the PublicSquare Portal?**
