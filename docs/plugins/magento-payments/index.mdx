...
# Integrating Credova Payments with Magento

Credova Magento Payments Plugin is a 1-click plugin for Magento that allows you to accept credit and debit card payments instantly.
...
3. In the payment method selection, choose the configured Credit/Debit Card (Credova) option
...
3. Confirm that the payment method displays as Credit/Debit Card (Credova)
...
- For further guidance or troubleshooting, please refer to the Credova API Documentation
