...
# Integrating Credova Payments with BigCommerce

Credova BigCommerce Payments Plugin is a 1-click plugin for BigCommerce that allows you to accept credit and debit card payments instantly.
...
This guide will walk you through setting up the Credova Payments app in BigCommerce. Follow the steps below carefully to ensure a smooth installation and configuration process.
...
4. **Set Account Details**
   - **Name:** Enter a descriptive name (e.g., Credova Payments)
...
1. Navigate to the [Credova plugin setup page](https://bigcommerce-plugin.publicsquare.com/installation/setup)
2. **Upload the File**
   - Drag and drop the API credentials file

## Step 3: Add Payment API Keys

1. Copy the **API Keys** from your [Credova Portal](https://portal.publicsquare.com/developers/api-keys)
