...
<Alert>You don't need to install <code>@publicsquare/elements-js</code> separately when using our React package, unless you need to direct import a capability from it.</Alert>
