...
This command serves the built site locally from the `build` directory. Use it to test a production build (including search, which only works in production mode) before deploying.
